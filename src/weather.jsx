    ...
    return (
        <div className="bg-black p-20">
            <div className=" bg-violet-400 p-10 rounded-md">
                ...
                <input onChange={handlecity} type="text" placeholder="enter your city name!" className="shadow-xl mt-2 border border-black rounded-md p-1 "></input><br></br>
                <button onClick={getWeather} className="bg-black text-white p-2 rounded-md mt-2">Get report</button>

                <div className="mt-4 p-5 rounded-md shadow-2xl ">
